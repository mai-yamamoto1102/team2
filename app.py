...
# app.config['MYSQL_HOST'] = os.getenv('DB_HOST', 'team2-mysql-version1.mysql.database.azure.com')
# app.config['MYSQL_USER'] = os.getenv('DB_USER', 'azureuser')  # 注意包含@服务器名
# app.config['MYSQL_PASSWORD'] = os.getenv('DB_PASSWORD', 'Password1234')
# app.config['MYSQL_DB'] = os.getenv('DB_NAME', 'attendance_system')
# app.config['MYSQL_SSL_CA'] = os.getenv('MYSQL_SSL_CA', 'BaltimoreCyberTrustRoot.crt.pem')  # SSL证书路径
...
#         # 获取数据库时区
#         cur.execute('SELECT @@time_zone as time_zone')
#         timezone = cur.fetchone()
        
#         cur.close()
        
#         # 收集证书信息
#         cert_path = app.config.get('MYSQL_SSL_CA', 'Not configured')
#         cert_exists = os.path.exists(cert_path) if cert_path != 'Not configured' else False
